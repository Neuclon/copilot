    ...
    return (
        <React.Fragment>
            <form onSubmit={handleSubmit} action="/register">
                ...
                <Rating name="netPromoterScore" defaultValue={2} max={10} 
                ...
                <Stack spacing={2} direction="row" sx={{ marginBottom: 4 }}>
                    <FormControl>
                        <FormLabel id="demo-row-radio-buttons-group-label">
                            Would you be willing to subscribe to ReferSpecs.com for continued access to specifications and standards tailored to your needs?
                        </FormLabel>
                        <RadioGroup
                            row
                            aria-labelledby="demo-row-radio-buttons-group-label"
            ...
            {uploadDone &&
            <Alert severity="success">Thank you for your input— We will get bak to you!</Alert>
            }
